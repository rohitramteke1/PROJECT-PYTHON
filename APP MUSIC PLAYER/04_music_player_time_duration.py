...
def play_time():
    try:
        ...
        status_bar_lbl.configure(text=f"{current_time} -/- {current_song_length}")
        # Update time
...
# # NOTE: Create a Status_bar
# status_bar = Label(root, text="Status Bar", relief="flat")
# status_bar.pack(fill=X, expand=True, side=BOTTOM)
