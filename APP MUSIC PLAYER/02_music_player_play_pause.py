...
play_list_box = Listbox(root, bg='#302f2f', fg="#fff", height=20, width=40, selectbackground="#25a796")
...
controls_btn_frame.pack(pady=10)

# Create buttons
play_btn = Button(controls_btn_frame, image=play_btn_img, bd=0, command=play_music, bg="#302f2f")
pause_btn = Button(controls_btn_frame, image=pause_btn_img, bd=0, command=lambda: pause_music(paused), bg="#302f2f")
backward_btn = Button(controls_btn_frame, image=backward_btn_img, bd=0, bg="#302f2f")
forward_btn = Button(controls_btn_frame, image=forward_btn_img, bd=0, bg="#302f2f")
stop_btn = Button(controls_btn_frame, image=stop_btn_img, bd=0, command=stop_music, bg="#302f2f")
